...
public class LoadingScreen extends ScreenAdapter {
	...
	public void show() {
		...
		assetManager.load(AssetDescriptors.RY);
		assetManager.load(AssetDescriptors.RY_RUN);
		assetManager.load(AssetDescriptors.STAGE_ONE_BACKGROUND);
		assetManager.load(AssetDescriptors.STAGE_TWO_BACKGROUND);
