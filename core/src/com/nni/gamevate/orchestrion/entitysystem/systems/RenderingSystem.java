...
import com.nni.gamevate.orchestrion.ZComparator;
...
public class RenderingSystem extends SortedIteratingSystem {
	...
	static final float PPM = 32.0f; // sets the amount of pixels each metre of
	// box2d objects contains

	// this gets the height and width of our camera frustrum based off the width
	// and height of the screen and our pixel per meter ratio
	static final float FRUSTUM_WIDTH = Gdx.graphics.getWidth() / PPM;
	static final float FRUSTUM_HEIGHT = Gdx.graphics.getHeight() / PPM;

	public static final float PIXELS_TO_METRES = 1.0f / PPM; // get the ratio
	// for converting
	// pixels to metres
	...
	private Array<Entity> renderQueue; // an array used to allow sorting of
	// images allowing us to draw images on
	// top of each other
	private Comparator<Entity> comparator; // a comparator to sort images based
	// on the z position of the
	// transfromComponent
	...
	public RenderingSystem(SpriteBatch batch) {
		...
		viewport = new ExtendViewport(GameConfig.WORLD_WIDTH, GameConfig.WORLD_HEIGHT, cam);
